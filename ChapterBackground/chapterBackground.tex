...
\subsection{P2P}
P2P provides scalability, but has challenges of data consistency, communication overhead and cheating. \cite{VoroGame} proposes VoroGame, which addresses these problems.
