...
%Fewer server connection requirements doesn't necessarily mean less network traffic.
...
%TODO: 3x3 diagram. Explain that opposite corners need not communicate with each other
