...
%TODO: Describe physics errors in detail here
%Late collisions
%Things not colliding (i.e. overlapping when they shouldn't be)
%Objects not being simulated
%Objects jittering
...
%Objects being simulated on different servers may end up occupying the same space.
...
PhysX is non-deterministic, as a result of this, repeating the same scenario with the exact same starting parameters does not necessarily lead to the exact same end state.
