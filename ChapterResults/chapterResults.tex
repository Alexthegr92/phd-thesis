...
%TODO: Outline: We've demonstrated a benchmark with which to compare distributed results with
...
\begin{figure}
	\begin{subfigure}[t]{0.325\columnwidth}
		\includegraphics[width=\linewidth]{MeanPenVsSpeedLow}
		\caption{$16m\mathord{\cdot}s^{-1}$}
		\label{fig_CollisionsPenVsSpeedLow}
	\end{subfigure}
	\hfill %%
	\begin{subfigure}[t]{0.325\columnwidth}
		\includegraphics[width=\linewidth]{MeanPenVsSpeedMid}
		\caption{$32m\mathord{\cdot}s^{-1}$}
		\label{fig_CollisionsPenVsSpeedMid}
	\end{subfigure}
	\hfill %%
	\begin{subfigure}[t]{0.325\columnwidth}
		\includegraphics[width=\linewidth]{MeanPenVsSpeedHigh}
		\caption{$48m\mathord{\cdot}s^{-1}$}
		\label{fig_CollisionsPenVsSpeedHigh}
	\end{subfigure}
	\caption{Mean penetration time of objects with $+/-2$ standard deviations with varying speed. The maximum expected penetration time of 1 physics step is marked with a dashed blue line. The speed tolerance is marked in a dashed green line.}
...
\begin{figure}
	\begin{subfigure}[t]{0.325\columnwidth}
		\includegraphics[width=\linewidth]{MeanPenVsLatencyLow}
		\caption{$2ms$}
		\label{fig_CollisionsPenVsLatencyLow}
	\end{subfigure}
	\hfill %%
	\begin{subfigure}[t]{0.325\columnwidth}
		\includegraphics[width=\linewidth]{MeanPenVsLatencyMid}
		\caption{$8ms$}
		\label{fig_CollisionsPenVsLatencyMid}
	\end{subfigure}
	\hfill %%
	\begin{subfigure}[t]{0.325\columnwidth}
		\includegraphics[width=\linewidth]{MeanPenVsLatencyHigh}
		\caption{$16ms$}
		\label{fig_CollisionsPenVsLatencyHigh}
	\end{subfigure}
	\caption{Mean penetration time of objects with $+/-2$ standard deviations with varying latency. The maximum expected penetration time of 1 physics step is marked with a dashed blue line. The latency tolerance is marked in a dashed green line.}
...
\begin{figure}
	\begin{subfigure}[t]{0.325\columnwidth}
		\includegraphics[width=\linewidth]{MeanPenVsFrameTimeLow}
		\caption{$8.33ms$}
		\label{fig_CollisionsPenVsFrameTimeLow}
	\end{subfigure}
	\hfill %%
	\begin{subfigure}[t]{0.325\columnwidth}
		\includegraphics[width=\linewidth]{MeanPenVsFrameTimeMid}
		\caption{$15ms$}
		\label{fig_CollisionsPenVsFrameTimeMid}
	\end{subfigure}
	\hfill %%
	\begin{subfigure}[t]{0.325\columnwidth}
		\includegraphics[width=\linewidth]{MeanPenVsFrameTimeHigh}
		\caption{$33.33ms$}
		\label{fig_CollisionsPenVsFrameTimeHigh}
	\end{subfigure}
	\caption{Mean penetration time of objects with $+/-2$ standard deviations with varying frame-time. The maximum expected penetration time of 1 physics step is marked with a dashed blue line. The frame-time tolerance is marked in a dashed green line.}
