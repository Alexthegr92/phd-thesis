...
\begin{figure}[t]
	...
	\caption{Ratio of Late to Correct Collisions and Misses to Total Collision vs. Speed using a latency tolerance of $2ms$. The latency tolerance is marked in a dashed green line.}
	\label{fig_RatioVsLatencyLow}
\end{figure}
\begin{figure}[t]
	\centering
	\includegraphics[width=\textwidth]{RatiosVsLatencyMid}
	\caption{Ratio of Late to Correct Collisions and Misses to Total Collision vs. Speed using a latency tolerance of $8ms$. The latency tolerance is marked in a dashed green line.}
	\label{fig_RatioVsLatencyMid}
\end{figure}
\begin{figure}[t]
	\centering
	\includegraphics[width=\textwidth]{RatiosVsLatencyHigh}
	\caption{Ratio of Late to Correct Collisions and Misses to Total Collision vs. Speed using a latency tolerance of $16ms$. The latency tolerance is marked in a dashed green line.}
...
\begin{figure}[t]
	...
	\caption{Ratio of Late to Correct Collisions and Misses to Total Collision vs.frame-time using a frame-time tolerance of $25ms$. The frame-time tolerance is marked in a dashed green line.}
